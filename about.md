...
* An algorithm demo to solve the "Largest Empty Convex Polygon" problem.
* Given a set of points in the 2-dimensional space, find the empty convex polygon with most points. 
...
* A DApp on Ethereum blockchain platform simulating the "ROSCA" protocal. 
