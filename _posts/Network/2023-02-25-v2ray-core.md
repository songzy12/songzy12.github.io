...
```
CONFIG=config.json
go run main/main.go run -config $CONFIG
```
...
```
> netsh interface portproxy add v4tov4 listenport=8080 listenaddress=0.0.0.0 connectport=8080 connectaddress=172.27.239.47
